...
root_dir = r'/media/cse/HDD/Shawon/shawon/MY DATA/LSA64 60fps' # Directory containing MP4 files


# Path to save the plot
output_plot_path = r"/media/cse/HDD/Shawon/shawon/MY DATA/frame_count_vs_video.png"
...
if frame_counts_sorted:
    ...
    plt.title("Sorted Frame Count vs. Video Index (Min to Max) -- LSA64")
